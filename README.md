# 《机器学习课程》第二次实验：神经网络对car_1000.txt进行分类

使用pytorch框架简单完成。后续准备实现手写神经网络完成实验

**本次实验非常简单，关键是对神经网络的调参**

[决策树实验链接](https://github.com/PerformapalSolv/ML-8-DecisionMaking-tree)
...
![image-20240422204344716](https://cdn.jsdelivr.net/gh/PerformapalSolv/githubChartBed@main/img/image-20240422204344716.png)

![image-20240422204405516](https://cdn.jsdelivr.net/gh/PerformapalSolv/githubChartBed@main/img/image-20240422204405516.png)
...
![image-20240422204126938](https://cdn.jsdelivr.net/gh/PerformapalSolv/githubChartBed@main/img/image-20240422204126938.png)

![image-20240422204143548](https://cdn.jsdelivr.net/gh/PerformapalSolv/githubChartBed@main/img/image-20240422204143548.png)